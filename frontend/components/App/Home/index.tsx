...
export function Home (props: IndexProps) {
    ...
    <main >
      <Box sx={{ bgcolor: '', pt: 16, pb: 6, }}>
        ...
        <Typography variant='h5' component='button' color='orange' >Warning!</Typography>
          ...
          <Button variant='contained' onClick={handleConnect}>ConnectWallet</Button>
          <Button variant="outlined">
            <Link color="rgba(150, 150, 150, 0.8)" sx={{
              '&:hover': {
                border: 'rgba(100, 100, 100, 0.5)'
              }
            }} href="https://github.com/bobeu/connect-to-celo-using-web3modal" underline='none'>Source code</Link> 
          </Button>
        </Stack>
      </Container>
    </Box>
